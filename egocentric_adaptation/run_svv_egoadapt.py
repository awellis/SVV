...
def play_voice(V, voice, dur=4):
    if V['task'] == 'egocentric':
        message = os.path.join(audio_dir, 'egocentric.wav')
        print("Message: egocentric")

    elif V['task'] == 'gravity':
        message = os.path.join(audio_dir, 'gravity.wav')
        print("Message: gravity")
